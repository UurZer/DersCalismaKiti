...
namespace dersCalismaKiti
{
    public partial class Form1 : Form
    {
        ...
        {
            if(varForFile.dateProccessStart().ToString().Length ==18)
                varForFile.dateStart= "0"+varForFile.dateProccessStart().ToString();
            else
        ...
        private void endTheWork_Click(object sender ,EventArgs e)
        {
            ...
            if (varForFile.dateProccessEnd().ToString().Length == 18)
                varForFile.dateEnd = "0" + varForFile.dateProccessEnd().ToString();
            else
        ...
        private void writeButton_Click(object sender, EventArgs e)
        {
            ...
            libVar.mainNoteText = notesTextbox.Text;
            libVar.bookNumber = numberTextBox.Text;
            libVar.writeNotes();
        }

        private void bunifuThinButton26_Click(object sender, EventArgs e)
        {
            System.Diagnostics.Process.Start(@"D:\C# Projeleri\dersCalismaKiti\BookNotes.txt");
        }
    }
}
